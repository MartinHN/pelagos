...
float4 sc=TransformWorldToShadowCoord(worldPos);
    ...
    // return att;
            ...
            half4 frag(Varyings IN) : SV_Target
            {
                ...
                float distTravelled = 0;//InterleavedGradientNoise(pixelCoords, (int)(_Time.y / max(HALF_EPS, unity_DeltaTime.x))) * _NoiseOffset;
                ...
                while(distTravelled < distLimit)
                {
                    ...
                    // {
                        ...
                        float att = SampleMainLightShadowAttenuation(rayPos);
                       ...
                       //transmittance *= exp( -mainLight.shadowAttenuation* _StepSize);
                    // }
